...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        "--model",
        type=str,
        default="/media/dell/新加卷/zym/foldingdiff/huang",
    ...
    parser.add_argument(
        "--outdir", "-o", type=str, default='/media/dell/新加卷/zym/foldingdiff/out_dir', help="Path to output directory"
    )
    parser.add_argument(
        "--num",
        "-n",
...
def main() -> None:
    ...
    if args.testcomparison:
        ...
        # 1. 生成天然蛋白质 Ramachandran 图
        # ================================
        plot_ramachandran(
            test_values_stacked[:, phi_idx],
            test_values_stacked[:, psi_idx],
            fname=plotdir / "ramachandran_natural_proteins.pdf",
            annot_ss=True
        )
        ...
        make_ss_cooccurrence_plot(
            test_dset.filenames,
            str(plotdir / "ss_cooccurrence_natural_proteins.pdf"),
