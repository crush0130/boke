...
PROTEINMPNN_SCRIPT = os.path.expanduser("/media/dell/新加卷/zym/ProteinMPNN/protein_mpnn_run.py")
...
def build_parser():
    ...
    parser.add_argument(
        "dirname",
        type=str,
        default=os.path.join('/media/dell/新加卷/zym/foldingdiff/out_dir/sample_pdb'),
    ...
    parser.add_argument(
        ...
        "--outdir",
        type=str,
        default=os.path.join("/media/dell/新加卷/zym/foldingdiff/out_dir/sampled_pdb", "proteinmpnn_residues"),
...
def main():
    ...
    pdb_fnames = list(glob(os.path.join("/media/dell/新加卷/zym/foldingdiff/out_dir/sampled_pdb", "*.pdb")))
